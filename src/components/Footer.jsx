...
export default function Footer() {
  return (
    <div
      className="bg-[#0b2341] w-full text-white pt-10 px-6 md:px-10 lg:px-20 overflow-hidden"
      id="footer"
    >
        ...
        <div className="w-full md:w-1/3 ">
          ...
          <p className="mb-2">
            <span className="font-semibold space-x-0.5">
              Rooster Tech M&E Pte Ltd
            </span>
          </p>
          <p className="mb-2">
            📍 5 Soon Lee Street, #06-28 Pioneer Point, Singapore 627607
          </p>
          <p className="mb-2">
          📩
            <a
            ...
            >
               roostertechsa@gmail.com
            </a>
          </p>
          <p className="mb-2">
            📞{" "}
            <a href="tel:+6591364098" className="hover:underline">
              +65 91364098
            </a>
          </p>
        </div>
      ...
      <div className="border-t border-orange-400 mt-10 py-4 text-center">
        © <span className="text-orange-400">Rooster Tech</span> All Right
        Reserved | crafted by Sharmila-Frontend Developer
      </div>
    </div>
  );
}
